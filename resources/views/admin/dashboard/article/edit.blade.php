                    ...
                    {{method_field('PUT')}}
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-6 col-md-8 col-sm-12">
                                <input class="form-control" type="text" id="title" name="title" placeholder="Enter Article Title" value="{{$data->judul}}"/>
                        ...
                        <div class="mb-3">
                        	...
                        	<textarea class="form-control " id="editor1" name="content">{{$data->isi}}</textarea>
